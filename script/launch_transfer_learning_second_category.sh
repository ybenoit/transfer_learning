...
python transfer_learning/train.py \
    ...
    --output_graph "model/vegetables/output_graph_vegetables_1.0_224_q.pb" \
    ...
    --summaries_dir "summaries/vegetables/1.0_224_q" \
    --intermediate_output_graphs_dir "model/vegetables/intermediate_graph_1.0_224_q" \
