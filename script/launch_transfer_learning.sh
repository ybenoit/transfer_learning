...
python transfer_learning/train.py \
    ...
    --output_graph "model/fruits/output_graph_fruits_simple_1.0_224_q.pb" \
    ...
    --summaries_dir "summaries/fruits/simple_1.0_224_q" \
    --intermediate_output_graphs_dir "model/fruits/intermediate_graph_simple_1.0_224_q/" \
